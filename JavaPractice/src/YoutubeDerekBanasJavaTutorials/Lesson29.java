...
public class Lesson29 extends JFrame{
    ...
    public Lesson29(){
        ...
        */
        ...
        //You create a GridBagConstraint object that defines
        ...
        //Defines where to place components if they don't fill the space: Center|North|South|East|Northeast|etc..
        ...
        gridConstraints.gridx = 5; //move everything to the right
        thePanel.add(textResult, gridConstraints);

        gridConstraints.gridwidth= 1;
        gridConstraints.gridx = 1; //Move things vertically down
        gridConstraints.gridy = 2; //Space down
        ...
        /*
            Add line buttons use the grid layout
            thePanel.add(but1);
            thePanel.add(but2);
            thePanel.add(but3);
            thePanel.add(but4);
