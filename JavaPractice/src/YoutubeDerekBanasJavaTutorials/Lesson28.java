...
public class Lesson28 extends JFrame {
    ...
    public Lesson28(){
        ...
        theBox.add(button1);
        theBox.add(Box.createHorizontalStrut(4)); //Space between buttons
        theBox.add(button2);
        //theBox.add(Box.createHorizontalGlue()); //Place button max distance from the others, but not off the screen
